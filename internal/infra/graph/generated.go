...
type ComplexityRoot struct {
	...
	Query struct {
		...
		Orders func(childComplexity int, page *int, perPage *int) int
	}
}
...
type QueryResolver interface {
	Orders(ctx context.Context, page *int, perPage *int) ([]*model.Order, error)
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.orders":
		...
		return e.complexity.Query.Orders(childComplexity, args["page"].(*int), args["perPage"].(*int)), true
...
func (ec *executionContext) field_Query_orders_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["page"] = arg0
	arg1, err := ec.field_Query_orders_argsPerPage(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["perPage"] = arg1
...
func (ec *executionContext) field_Query_orders_argsPerPage(
	ctx context.Context,
	rawArgs map[string]any,
) (*int, error) {
	if _, ok := rawArgs["perPage"]; !ok {
		var zeroVal *int
		return zeroVal, nil
	}
...
func (ec *executionContext) _Query_orders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Orders(rctx, fc.Args["page"].(*int), fc.Args["perPage"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) marshalNOrder2githubᚗcomᚋdevfullcycleᚋ20ᚑCleanArchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v model.Order) graphql.Marshaler {
